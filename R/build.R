...
copy_code(file.path(native_path, "pch"), file.path(cxx_path, "pch"))
copy_code(file.path(native_path, "inc"), file.path(cxx_path, "inc"))
copy_code(file.path(native_path, "unzoned"), file.path(cxx_path, "unzoned"))
copy_code(file.path(native_path, "bridge"), file.path(cxx_path, "bridge"))
