...
sample_without_replacement <- function(random_seed, count_training_samples, count_validation_samples, sample_counts_out) {
   ...
   result <- .Call(SampleWithoutReplacement_R, random_seed, count_training_samples, count_validation_samples, sample_counts_out)
   if(is.null(result)) {
