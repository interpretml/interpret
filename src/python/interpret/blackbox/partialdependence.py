...
class PartialDependence(ExplainerMixin):
    ...
    @classmethod
    def _gen_pdp(cls, X, predict_fn, col_idx, feature_type,
                 num_points=10, std_coef=1.0,
                 num_ice_samples=10):
    ...
    def explain_global(self, name=None):
        ...
        for col_idx, feature in enumerate(self.feature_names):
            ...
            pdp = PartialDependence._gen_pdp(
                self.data, self.predict_fn, col_idx, feature_type,
        ...
        return PDPExplanation('global', internal_obj,
