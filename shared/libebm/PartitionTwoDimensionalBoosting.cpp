                  ...
                  *pTotalGain = static_cast<double>(bestGain);
                  ...
                  do {
                     ...
                     do {
                        ...
                        if(nullptr != pTensorWeights || nullptr != pTensorHess) {
                           ...
                           pTensorGradientPair = pTempScratch->GetGradientPairs();
                           tensorHess = static_cast<FloatCalc>(pTempScratch->GetWeight());
