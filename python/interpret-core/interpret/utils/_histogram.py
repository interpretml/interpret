...
def _make_histogram_edges(min_feature_val, max_feature_val, histogram_weights):
    ...
    if len(cuts) != n_cuts:
        msg = f"Insufficient distinct floating point values between min_feature_val={min_feature_val} and max_feature_val={max_feature_val} to create {n_cuts} histogram cuts."
