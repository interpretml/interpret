...
class BaseShallowDecisionTree(LocalExplainer, GlobalExplainer, _SKBaseEstimator):
...
class RegressionTree(_SKRegressorMixin, BaseShallowDecisionTree):
    ...
    def fit(self, X, y, sample_weight=None, check_input=True):
        ...
        try:
            ...
            raise ImportError(
                "scikit-learn is required for RegressionTree. Install it with: pip install scikit-learn"
            )
...
class ClassificationTree(_SKClassifierMixin, BaseShallowDecisionTree):
    ...
    def fit(self, X, y, sample_weight=None, check_input=True):
        ...
        try:
            ...
            raise ImportError(
                "scikit-learn is required for ClassificationTree. Install it with: pip install scikit-learn"
            )
