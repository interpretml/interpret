...
class EBMExplanation(FeatureValueExplanation):
    ...
    def visualize(self, key: int | None = None, title: str | None = None) -> Any:
        ...
        if self.explanation_type == "global" and key is None:
            ...
            figure._interpret_help_link = "https://github.com/interpretml/interpret/blob/main/docs/interpret/python/examples/group-importances.ipynb"
...
class BaseEBM(LocalExplainer, GlobalExplainer, _SKBaseEstimator):
    ...
    def fit(
        ...
        if not getattr(self, "_is_differentially_private", False):
        ...
        is_differential_privacy = getattr(self, "_is_differentially_private", False)
...
class EBMClassifierMixin(_SKClassifierMixin):
...
class EBMRegressorMixin(_SKRegressorMixin):
