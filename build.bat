...
MSBuild.exe "%script_path%src\core\ebmcore\ebmcore.vcxproj" /p:Configuration=Release /p:Platform=x86
IF %ERRORLEVEL% NEQ 0 (
...
MSBuild.exe "%script_path%src\core\ebmcore\ebmcore.vcxproj" /p:Configuration=Debug /p:Platform=x86
IF %ERRORLEVEL% NEQ 0 (
