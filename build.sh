...
compile_all="$compile_all \"$src_path/BinningQuantile.cpp\""
compile_all="$compile_all \"$src_path/BinningUniform.cpp\""
compile_all="$compile_all \"$src_path/BinningWinsorized.cpp\""
...
compile_all="$compile_all -Wall"
compile_all="$compile_all -Wextra"
...
compile_all="$compile_all -fvisibility=hidden"
compile_all="$compile_all -fvisibility-inlines-hidden"
compile_all="$compile_all -fno-math-errno"
compile_all="$compile_all -fno-trapping-math"
