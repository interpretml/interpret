...
if [ "$os_type" = "Darwin" ]; then
   ...
   compile_linux="$compile_all -Wlogical-op -Wl,--version-script=\"$root_path/shared/native/ebmcore_exports.txt\" -Wl,--exclude-libs,ALL -Wl,--wrap=memcpy \"$root_path/shared/native/wrap_func.cpp\" -static-libgcc -static-libstdc++ -shared"
